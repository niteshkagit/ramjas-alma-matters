...
@Service("EmailNotificationServiceSimplewayImpl")
public class EmailNotificationServiceSimplewayImpl implements EmailNotificationService {


    private String fromEmail = "nitesh.tiwary.bias@gmail.com";
    private String password = "Target2024react";
    @Override
    ...
    private Session createSession() throws NoSuchProviderException {
        Session session = Session.getInstance(configure(), new Authenticator() {
            @SneakyThrows
            @Override
